...
+function (a) {
    ...
    g.VERSION = "3.3.2", g.prototype.toggle = function (d) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (b(), !g) {
                "ontouchstart"in document.documentElement && !f.closest(".navbar-nav").length && a('<div functions="dropdown-backdrop"/>').insertAfter(a(this)).on("click", b);
    ...
    c.VERSION = "3.3.2", c.TRANSITION_DURATION = 300, c.BACKDROP_TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = a('<div functions="modal-backdrop ' + e + '" />').prependTo(this.$element).on("click.dismiss.bs.modal", a.proxy(function (a) {
