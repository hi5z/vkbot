...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        Статус: <? if ($accountinfo['response'][0]['online'] == '1') {echo '<font color="green">Online</font>';} else {echo '<font color="red">Offline</font>';} ?><br />
            ...
            <div class="media">
                <div class="media-left">
                    <a href="http://vk.com/id<?=$friendsget['response']['items'][$i]?>">
                        <img class="media-object" width="50px" src="<?=$friendinfo['response'][0]['photo_max']?>" alt="<?=$friendinfo['response'][0]['first_name']?> <?=$friendinfo['response'][0]['last_name']?>">
                    </a>
                </div>
